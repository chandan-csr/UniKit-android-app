...
class NoteAdapter(context: Context, noteList:MutableList<NoteModel>): BaseAdapter() {
    private  val inflater: LayoutInflater =LayoutInflater.from(context)
    private  var itemList=noteList
    ...
    override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
        ...
        val itemDataText = itemList.get(p0).itemDataText as String
        ...
        if (p1 == null) {
            view = inflater.inflate(R.layout.new_itemlayout, p2, false)
